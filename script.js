...
(function () {
    var salonSeoByPath = {
        ...
        '/salony/lenina-76': {
            meta: 'Очки за 1 час при стандартном рецепте. Оптика у метро Пролетарская, пр. Ленина 76. Базовый комплект от 2 990 ₽. Пн-Пт 9:00-20:00, Сб-Вс 10:00-19:00. Запись онлайн.',
        ...
        '/salony/rokossovskogo-17': {
            meta: 'Оптика в Советском районе, ул. Рокоссовского 17. На пересечении с ул. Ванеева. Очки от 2 990 ₽ и бесплатная проверка зрения. Пн-Пт 9:00-20:00, Сб-Вс 10:00-19:00.',
            image: 'https://optikadobryhcen.ru/salony/images/rokossovskogo-17-fasad.png'
        }
    };
    ...
    if (salonMain && !salonMain.querySelector('section.faq')) {
        ...
        var faqBySalonPath = {
            ...
            '/salony/leskova-2': {
                title: 'Частые вопросы по салону на Лескова, 2',
                items: [
                    {
                    ...
                    {
                        q: 'Где вас найти на Лескова?',
                        a: 'Салон находится на пересечении улиц Лескова и Веденяпина.'
                    },
                    {
            ...
            '/salony/rokossovskogo-17': {
                title: 'Частые вопросы по салону на Рокоссовского, 17',
                items: [
                    {
                        q: 'Где находится салон на Рокоссовского, 17?',
                        a: 'Салон расположен в Советском районе, на пересечении ул. Рокоссовского и ул. Ванеева.'
                    },
                    {
                        q: 'Какой график работы?',
                        a: 'Пн–Пт 9:00–20:00, Сб–Вс 10:00–19:00.'
                    },
                    {
                        q: 'Нужна ли запись на проверку зрения?',
                        a: 'Можно прийти без записи, но заявка на сайте или в WhatsApp поможет пройти без ожидания.'
                    }
                ]
            }
        };
...
var SALONS_NNOV = [
    ...
    { name: 'ул. Лескова, 2', address: 'Нижний Новгород, улица Лескова, 2', lat: 56.23993, lon: 43.86585 },
    ...
    { name: 'ул. Рокоссовского, 17', address: 'Нижний Новгород, улица Маршала Рокоссовского, 17', lat: 56.28394, lon: 44.04114 }
];
